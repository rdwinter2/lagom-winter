package com.roguebluesoftware.lagomwinter.api
...
object LagomWinterService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The Lagom Winter service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the LagomWinterService.
  */
trait LagomWinterService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("lagom-winter")
      ...
      .withTopics(
        topic(LagomWinterService.TOPIC_NAME, greetingsTopic _)
